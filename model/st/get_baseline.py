...
from model.v3.DSDynunet import Deep_DynUNet
from model.v3.DynUnet_CBAM import DynUNet_CBAM
from model.v3.DSDynUnet_CBAM import DS_DynUNet_CBAM
from model.v3.DSDynUnet_DDA import DS_DynUNet_DDA
...
def get_model(name, att = None, in_channels=4, out_channels=3):
    ...
    elif name == "dsdynunet_dda":
        print(att)
        model = DS_DynUNet_DDA(spatial_dims=3,
                in_channels=in_channels,
                out_channels=out_channels,
                filters = [32, 64, 128, 256, 320, 320],
                kernel_size= [[3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3]],
